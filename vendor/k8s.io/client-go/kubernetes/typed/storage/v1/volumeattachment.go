...
type VolumeAttachmentInterface interface {
	...
	Get(name string, options meta_v1.GetOptions) (*v1.VolumeAttachment, error)
	List(opts meta_v1.ListOptions) (*v1.VolumeAttachmentList, error)
...
func (c *volumeAttachments) Get(name string, options meta_v1.GetOptions) (result *v1.VolumeAttachment, err error) {
...
func (c *volumeAttachments) List(opts meta_v1.ListOptions) (result *v1.VolumeAttachmentList, err error) {
...
func (c *volumeAttachments) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("volumeattachments").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *volumeAttachments) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *volumeAttachments) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Resource("volumeattachments").
